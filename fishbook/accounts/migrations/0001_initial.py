    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fishing_style', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('float_fishing', 'Float fishing'), ('feeder_fishing', 'Feeder fishing'), ('fly_fishing', 'Fly fishing'), ('carp_fishing', 'Carp fishing'), ('spin_fishing', 'Spin fishing'), ('ice_fishing', 'Ice fishing'), ('trolling_fishing', 'Trolling fishing'), ('salt_water_fishing', 'Salt water fishing'), ('spear_fishing', 'Spear_fishing')], max_length=18, null=True)),
